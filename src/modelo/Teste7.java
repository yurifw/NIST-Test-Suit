...
/**
 * <p> Teste do Correspondente Modelo Não-Sobreposto</p>
 * <p>Classe responsável por verificar se a sequência de bits produzida por geradores é uma sequência padrão não-periódico</p>
